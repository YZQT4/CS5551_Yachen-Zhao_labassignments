...
public class LoginActivity extends AppCompatActivity {
    ...
    public void checkCredentials(View v)
    {
        ...
        if(!userName.isEmpty() && !password.isEmpty()) {
            if(userName.equals("Yachen") && password.equals("123456")) {
                validationFlag = true;
    ...
    public void jumpn(View v)
    {
        Intent redirectn = new Intent(LoginActivity.this, RegisterActivity.class);
        startActivity(redirectn);
