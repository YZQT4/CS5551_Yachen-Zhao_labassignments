...
public class MainActivity extends Activity {
    ...
    public void weather(View v) {
        ...
        String getURL = "http://api.wunderground.com/api/4bbbc25f4f5946dd/conditions/q/" + z + ".json";
        ...
        try {
            ...
            for(int t=0;t<array.length();t++){
                if(array.getJSONObject(t).getString("country_name").equalsIgnoreCase("USA")){
                    i = array.getJSONObject(t).getString("state");
                    break;
                };
            }
        ...
        String UR = "http://api.wunderground.com/api/4bbbc25f4f5946dd/conditions/q/" + i + "/" + z + ".json";
        ...
        try {
           ...
           String city1=  ((EditText) findViewById(R.id.editext_cityname)).getText().toString();
            ...
            mTextView.setText("Temperature in"+city1+":"+"\n" + dis.toString());
        } catch (Exception e) {
